...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/notifications-subscriptions-menu.572fff1cb5c3caef1ac9.module.css" />
  ...
  <title>alx-backend-python/0x00-python_variable_annotations/6-sum_mixed_list.py at main · Onielcares/alx-backend-python · GitHub</title>
  ...
  <meta name="request-id" content="8A4E:32E7CF:155BE:1BFA7:66BDA68C" data-pjax-transient="true"/><meta name="html-safe-nonce" content="68370ff6cfdd708757066b6d96b71b162baa696455f4f788555237f66e4847d3" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6IiIsInJlcXVlc3RfaWQiOiI4QTRFOjMyRTdDRjoxNTVCRToxQkZBNzo2NkJEQTY4QyIsInZpc2l0b3JfaWQiOiI0MjU0NjEyNjg2OTUzNjIxMTMyIiwicmVnaW9uX2VkZ2UiOiJpYWQiLCJyZWdpb25fcmVuZGVyIjoiaWFkIn0=" data-pjax-transient="true"/><meta name="visitor-hmac" content="5b78cc60568f25b2d61522653307eed69186ddccccce7b917d3cbb3bd1a4a000" data-pjax-transient="true"/>
  ...
  <div class="d-flex flex-column flex-lg-row flex-items-center px-3 px-md-4 px-lg-5 height-full position-relative z-1">
    ...
    <path d="M12.5.75C6.146.75 1 5.896 1 12.25c0 5.089 3.292 9.387 7.863 10.91.575.101.79-.244.79-.546 0-.273-.014-1.178-.014-2.142-2.889.532-3.636-.704-3.866-1.35-.13-.331-.69-1.352-1.18-1.625-.402-.216-.977-.748-.014-.762.906-.014 1.553.834 1.769 1.179 1.035 1.74 2.688 1.25 3.349.948.1-.747.402-1.25.733-1.538-2.559-.287-5.232-1.279-5.232-5.678 0-1.25.445-2.285 1.178-3.09-.115-.288-.517-1.467.115-3.048 0 0 .963-.302 3.163 1.179.92-.259 1.897-.388 2.875-.388.977 0 1.955.13 2.875.388 2.2-1.495 3.162-1.179 3.162-1.179.633 1.581.23 2.76.115 3.048.733.805 1.179 1.825 1.179 3.09 0 4.413-2.688 5.39-5.247 5.678.417.36.776 1.05.776 2.128 0 1.538-.014 2.774-.014 3.162 0 .302.216.662.79.547C20.709 21.637 24 17.324 24 12.25 24 5.896 18.854.75 12.5.75Z"></path>
      ...
      <div class="flex-1 flex-order-2 text-right">
          <a
            href="/login?return_to=https%3A%2F%2Fgithub.com%2FOnielcares%2Falx-backend-python%2Fblob%2Fmain%2F0x00-python_variable_annotations%2F6-sum_mixed_list.py"
            class="HeaderMenu-link HeaderMenu-button d-inline-flex d-lg-none flex-order-1 f5 no-underline border color-border-default rounded-2 px-2 py-1 color-fg-inherit js-prevent-focus-on-mobile-nav"
            data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;site header menu&quot;,&quot;repository_id&quot;:null,&quot;auth_type&quot;:&quot;SIGN_UP&quot;,&quot;originating_url&quot;:&quot;https://github.com/Onielcares/alx-backend-python/blob/main/0x00-python_variable_annotations/6-sum_mixed_list.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="91b23aa0e85c39c94ee484f266f9b7431e0d7c23e92d4aab1941c08850f7b36a"
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-445b0543-eae8-41d3-9508-6701cb3eb0a3" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-445b0543-eae8-41d3-9508-6701cb3eb0a3" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="0QHtv8pQqvBMxDlW8WvPPf9p6RsnYHGj3B2A5mCAUWzLX8PpINm8DQf6swrqxWFZbuxQzw5a24JGiie2B9HOBA==" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="J5UX/yAJrGOXlyxj+0lLIGv58TRVFy5f98sFFVH83Ktb4BYlckuJgEDyC1NUiq1teoDtzVheM3GNUAF+76Gt/A==" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" data-csrf="true" value="C/RP6uyU6TgQ7QtFzc+XjgXi/e+HABScW03yoi4DnQbEmCSHRkWdck9/q42KFeJKVLa6TaaBQKR4QarbLcAgfQ==" />
            </auto-check>
          </div>
    ...
    <button id="icon-button-f4097ba3-84f8-4a2e-b703-79efd27e35ec" aria-labelledby="tooltip-6feefaa4-a887-48f6-83db-5b30e1c4b304" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-6feefaa4-a887-48f6-83db-5b30e1c4b304" for="icon-button-f4097ba3-84f8-4a2e-b703-79efd27e35ec" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  ...
  <li>
            <a href="/login?return_to=%2FOnielcares%2Falx-backend-python" rel="nofollow" id="repository-details-watch-button" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;notification subscription menu watch&quot;,&quot;repository_id&quot;:null,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/Onielcares/alx-backend-python/blob/main/0x00-python_variable_annotations/6-sum_mixed_list.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="69cfeb46a4182aaaaaa23aa5714b08d8dc101d51bf04020952ecfbfc86ab0919" aria-label="You must be signed in to change notification settings" data-view-component="true" class="btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-bell mr-2">
    <path d="M8 16a2 2 0 0 0 1.985-1.75c.017-.137-.097-.25-.235-.25h-3.5c-.138 0-.252.113-.235.25A2 2 0 0 0 8 16ZM3 5a5 5 0 0 1 10 0v2.947c0 .05.015.098.042.139l1.703 2.555A1.519 1.519 0 0 1 13.482 13H2.518a1.516 1.516 0 0 1-1.263-2.36l1.703-2.554A.255.255 0 0 0 3 7.947Zm5-3.5A3.5 3.5 0 0 0 4.5 5v2.947c0 .346-.102.683-.294.97l-1.703 2.556a.017.017 0 0 0-.003.01l.001.006c0 .002.002.004.004.006l.006.004.007.001h10.964l.007-.001.006-.004.004-.006.001-.007a.017.017 0 0 0-.003-.01l-1.703-2.554a1.745 1.745 0 0 1-.294-.97V5A3.5 3.5 0 0 0 8 1.5Z"></path>
</svg>Notifications
</a>    <tool-tip id="tooltip-391084ec-8107-48a3-ae2d-ce290ecf77df" for="repository-details-watch-button" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">You must be signed in to change notification settings</tool-tip>

    </li>

  <li>
          <a icon="repo-forked" id="fork-button" href="/login?return_to=%2FOnielcares%2Falx-backend-python" rel="nofollow" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;repo details fork button&quot;,&quot;repository_id&quot;:585715319,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/Onielcares/alx-backend-python/blob/main/0x00-python_variable_annotations/6-sum_mixed_list.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="0346a6abdd9b84ea96f6280a4f64580727020e71a2768e913784d94ba2809925" data-view-component="true" class="btn-sm btn">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-repo-forked mr-2">
  ...
  <li>
        ...
        <a href="/login?return_to=%2FOnielcares%2Falx-backend-python" rel="nofollow" data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;star button&quot;,&quot;repository_id&quot;:585715319,&quot;auth_type&quot;:&quot;LOG_IN&quot;,&quot;originating_url&quot;:&quot;https://github.com/Onielcares/alx-backend-python/blob/main/0x00-python_variable_annotations/6-sum_mixed_list.py&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="80ca5de53354c5e90f19a7b1d4bb423f55b204e9070b1bd618e392f3654ff531" aria-label="You must be signed in to star a repository" data-view-component="true" class="tooltipped tooltipped-s btn-sm btn BtnGroup-item">    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-star v-align-text-bottom d-inline-block mr-2">
  ...
  <focus-group direction="vertical" mnemonics retain>
    <button id="action-menu-dc3fc3ab-a8a5-4ce3-81dc-b1f81a2aef44-button" popovertarget="action-menu-dc3fc3ab-a8a5-4ce3-81dc-b1f81a2aef44-overlay" aria-controls="action-menu-dc3fc3ab-a8a5-4ce3-81dc-b1f81a2aef44-list" aria-haspopup="true" aria-labelledby="tooltip-57e1a3da-d4b6-49a7-87c2-da94c5caf1c2" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium UnderlineNav-item">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-kebab-horizontal Button-visual">
    <path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
</svg>
</button><tool-tip id="tooltip-57e1a3da-d4b6-49a7-87c2-da94c5caf1c2" for="action-menu-dc3fc3ab-a8a5-4ce3-81dc-b1f81a2aef44-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Additional navigation options</tool-tip>


<anchored-position id="action-menu-dc3fc3ab-a8a5-4ce3-81dc-b1f81a2aef44-overlay" anchor="action-menu-dc3fc3ab-a8a5-4ce3-81dc-b1f81a2aef44-button" align="start" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  <div data-view-component="true" class="Overlay Overlay--size-auto">
    
      <div data-view-component="true" class="Overlay-body Overlay-body--paddingNone">          <action-list>
  <div data-view-component="true">
    <ul aria-labelledby="action-menu-dc3fc3ab-a8a5-4ce3-81dc-b1f81a2aef44-button" id="action-menu-dc3fc3ab-a8a5-4ce3-81dc-b1f81a2aef44-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
        <li hidden="hidden" data-menu-item="i0code-tab" data-targets="action-list.items" role="none" data-view-component="true" class="ActionListItem">
    
    
    <a tabindex="-1" id="item-e8cec4c7-bb1f-476f-9f86-dce71cdd97c6" href="/Onielcares/alx-backend-python" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
    ...
    <a tabindex="-1" id="item-f889c50e-945f-4f20-9f87-4e4ab8f77367" href="/Onielcares/alx-backend-python/issues" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-ec88d430-3c9b-4156-b1d1-7504fec44e94" href="/Onielcares/alx-backend-python/pulls" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-1b6cc697-d1fe-4fcb-85a3-48acf78ba11b" href="/Onielcares/alx-backend-python/actions" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-play">
    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-5d9f8843-3bff-4e7d-8814-8ef37b40959c" href="/Onielcares/alx-backend-python/projects" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-c4e5cd11-1479-46ba-9e13-51171744dea6" href="/Onielcares/alx-backend-python/security" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-128bf84d-b396-4e1a-a75d-6f960747ce28" href="/Onielcares/alx-backend-python/pulse" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<react-app
  ...
  initial-path="/Onielcares/alx-backend-python/blob/main/0x00-python_variable_annotations/6-sum_mixed_list.py"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"allShortcutsEnabled":false,"fileTree":{"0x00-python_variable_annotations":{"items":[{"name":"0-add.py","path":"0x00-python_variable_annotations/0-add.py","contentType":"file"},{"name":"1-concat.py","path":"0x00-python_variable_annotations/1-concat.py","contentType":"file"},{"name":"100-safe_first_element.py","path":"0x00-python_variable_annotations/100-safe_first_element.py","contentType":"file"},{"name":"101-safely_get_value.py","path":"0x00-python_variable_annotations/101-safely_get_value.py","contentType":"file"},{"name":"102-type_checking.py","path":"0x00-python_variable_annotations/102-type_checking.py","contentType":"file"},{"name":"2-floor.py","path":"0x00-python_variable_annotations/2-floor.py","contentType":"file"},{"name":"3-to_str.py","path":"0x00-python_variable_annotations/3-to_str.py","contentType":"file"},{"name":"4-define_variables.py","path":"0x00-python_variable_annotations/4-define_variables.py","contentType":"file"},{"name":"5-sum_list.py","path":"0x00-python_variable_annotations/5-sum_list.py","contentType":"file"},{"name":"6-sum_mixed_list.py","path":"0x00-python_variable_annotations/6-sum_mixed_list.py","contentType":"file"},{"name":"7-to_kv.py","path":"0x00-python_variable_annotations/7-to_kv.py","contentType":"file"},{"name":"8-make_multiplier.py","path":"0x00-python_variable_annotations/8-make_multiplier.py","contentType":"file"},{"name":"9-element_length.py","path":"0x00-python_variable_annotations/9-element_length.py","contentType":"file"},{"name":"README.md","path":"0x00-python_variable_annotations/README.md","contentType":"file"}],"totalCount":14},"":{"items":[{"name":"0x00-python_variable_annotations","path":"0x00-python_variable_annotations","contentType":"directory"},{"name":"0x01-python_async_function","path":"0x01-python_async_function","contentType":"directory"},{"name":"0x02-python_async_comprehension","path":"0x02-python_async_comprehension","contentType":"directory"},{"name":"0x03-Unittests_and_integration_tests","path":"0x03-Unittests_and_integration_tests","contentType":"directory"},{"name":"README.md","path":"README.md","contentType":"file"}],"totalCount":5}},"fileTreeProcessingTime":3.0999589999999997,"foldersToFetch":[],"repo":{"id":585715319,"defaultBranch":"main","name":"alx-backend-python","ownerLogin":"Onielcares","currentUserCanPush":false,"isFork":false,"isEmpty":false,"createdAt":"2023-01-05T22:09:07.000Z","ownerAvatar":"https://avatars.githubusercontent.com/u/67694750?v=4","public":true,"private":false,"isOrgOwned":false},"codeLineWrapEnabled":false,"symbolsExpanded":false,"treeExpanded":true,"refInfo":{"name":"main","listCacheKey":"v0:1672957591.907913","canEdit":false,"refType":"branch","currentOid":"fc8bf6f98b2423d23f16435dd9b207dcec91b740"},"path":"0x00-python_variable_annotations/6-sum_mixed_list.py","currentUser":null,"blob":{"rawLines":["#!/usr/bin/env python3","\"\"\"","Contains a function that takes a mixed list of integers and","floats and returns the sum of all the numbers in the list as float","\"\"\"","from typing import List, Union","","","def sum_mixed_list(mxd_lst: List[Union[int, float]]) -\u003e float:","    \"\"\"Takes a mixed list of integers and floats and returns the","    sum of all the numbers in the list as float\"\"\"","    return sum(mxd_lst)"],"stylingDirectives":[[{"s":0,"e":22,"c":"pl-c"}],[{"s":0,"e":3,"c":"pl-s"}],[{"s":0,"e":59,"c":"pl-s"}],[{"s":0,"e":66,"c":"pl-s"}],[{"s":0,"e":3,"c":"pl-s"}],[{"s":0,"e":4,"c":"pl-k"},{"s":5,"e":11,"c":"pl-s1"},{"s":12,"e":18,"c":"pl-k"},{"s":19,"e":23,"c":"pl-v"},{"s":25,"e":30,"c":"pl-v"}],[],[],[{"s":0,"e":3,"c":"pl-k"},{"s":4,"e":18,"c":"pl-en"},{"s":19,"e":26,"c":"pl-s1"},{"s":28,"e":32,"c":"pl-v"},{"s":33,"e":38,"c":"pl-v"},{"s":39,"e":42,"c":"pl-s1"},{"s":44,"e":49,"c":"pl-s1"},{"s":53,"e":55,"c":"pl-c1"},{"s":56,"e":61,"c":"pl-s1"}],[{"s":4,"e":64,"c":"pl-s"}],[{"s":0,"e":50,"c":"pl-s"}],[{"s":4,"e":10,"c":"pl-k"},{"s":11,"e":14,"c":"pl-en"},{"s":15,"e":22,"c":"pl-s1"}]],"colorizedLines":null,"csv":null,"csvError":null,"dependabotInfo":{"showConfigurationBanner":false,"configFilePath":null,"networkDependabotPath":"/Onielcares/alx-backend-python/network/updates","dismissConfigurationNoticePath":"/settings/dismiss-notice/dependabot_configuration_notice","configurationNoticeDismissed":null},"displayName":"6-sum_mixed_list.py","displayUrl":"https://github.com/Onielcares/alx-backend-python/blob/main/0x00-python_variable_annotations/6-sum_mixed_list.py?raw=true","headerInfo":{"blobSize":"394 Bytes","deleteTooltip":"You must be signed in to make or propose changes","editTooltip":"You must be signed in to make or propose changes","ghDesktopPath":"https://desktop.github.com","isGitLfs":false,"onBranch":true,"shortPath":"1debbfa","siteNavLoginPath":"/login?return_to=https%3A%2F%2Fgithub.com%2FOnielcares%2Falx-backend-python%2Fblob%2Fmain%2F0x00-python_variable_annotations%2F6-sum_mixed_list.py","isCSV":false,"isRichtext":false,"toc":null,"lineInfo":{"truncatedLoc":"12","truncatedSloc":"10"},"mode":"executable file"},"image":false,"isCodeownersFile":null,"isPlain":false,"isValidLegacyIssueTemplate":false,"issueTemplate":null,"discussionTemplate":null,"language":"Python","languageID":303,"large":false,"planSupportInfo":{"repoIsFork":null,"repoOwnedByCurrentUser":null,"requestFullPath":"/Onielcares/alx-backend-python/blob/main/0x00-python_variable_annotations/6-sum_mixed_list.py","showFreeOrgGatedFeatureMessage":null,"showPlanSupportBanner":null,"upgradeDataAttributes":null,"upgradePath":null},"publishBannersInfo":{"dismissActionNoticePath":"/settings/dismiss-notice/publish_action_from_dockerfile","releasePath":"/Onielcares/alx-backend-python/releases/new?marketplace=true","showPublishActionBanner":false},"rawBlobUrl":"https://github.com/Onielcares/alx-backend-python/raw/main/0x00-python_variable_annotations/6-sum_mixed_list.py","renderImageOrRaw":false,"richText":null,"renderedFileInfo":null,"shortPath":null,"symbolsEnabled":true,"tabSize":8,"topBannersInfo":{"overridingGlobalFundingFile":false,"globalPreferredFundingPath":null,"showInvalidCitationWarning":false,"citationHelpUrl":"https://docs.github.com/github/creating-cloning-and-archiving-repositories/creating-a-repository-on-github/about-citation-files","actionsOnboardingTip":null},"truncated":false,"viewable":true,"workflowRedirectUrl":null,"symbols":{"timed_out":false,"not_analyzed":false,"symbols":[{"name":"sum_mixed_list","kind":"function","ident_start":195,"ident_end":209,"extent_start":191,"extent_end":393,"fully_qualified_name":"sum_mixed_list","ident_utf16":{"start":{"line_number":8,"utf16_col":4},"end":{"line_number":8,"utf16_col":18}},"extent_utf16":{"start":{"line_number":8,"utf16_col":0},"end":{"line_number":11,"utf16_col":23}}}]}},"copilotInfo":null,"copilotAccessAllowed":false,"csrf_tokens":{"/Onielcares/alx-backend-python/branches":{"post":"S20epp1vCGu5gpKjFVtBTZTvqpDimuc5SCFI3E2se32vkeaAK1Q6-8-gdVhsnKlYDGqWZ3oLZtVqVPiVVZIRaA"},"/repos/preferences":{"post":"z4PziHAwkpeckVGaAgtJ095XTp2M01sFGYnKgySuwIM_OuxGfSrBZ17RLyb_F1uRKDFTIBrE_0YJTB-WHoqBYw"}}},"title":"alx-backend-python/0x00-python_variable_annotations/6-sum_mixed_list.py at main · Onielcares/alx-backend-python","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-1583894afd38.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-3a63a487027b.js","githubDevUrl":null,"enabled_features":{"code_nav_ui_events":false,"overview_shared_code_dropdown_button":false,"react_blob_overlay":false,"copilot_conversational_ux_embedding_update":false,"copilot_smell_icebreaker_ux":true,"copilot_workspace":false}}}</script>
...
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC9" class="react-file-line html-div" data-testid="code-cell" data-line-number="9" style="position:relative"><span class="pl-k">def</span> <span class="pl-en">sum_mixed_list</span>(<span class="pl-s1">mxd_lst</span>: <span class="pl-v">List</span>[<span class="pl-v">Union</span>[<span class="pl-s1">int</span>, <span class="pl-s1">float</span>]]) <span class="pl-c1">-&gt;</span> <span class="pl-s1">float</span>:</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC10" class="react-file-line html-div" data-testid="code-cell" data-line-number="10" style="position:relative">    <span class="pl-s">&quot;&quot;&quot;Takes a mixed list of integers and floats and returns the</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC11" class="react-file-line html-div" data-testid="code-cell" data-line-number="11" style="position:relative"><span class="pl-s">    sum of all the numbers in the list as float&quot;&quot;&quot;</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC12" class="react-file-line html-div" data-testid="code-cell" data-line-number="12" style="position:relative">    <span class="pl-k">return</span> <span class="pl-en">sum</span>(<span class="pl-s1">mxd_lst</span>)</div></div></div></div></div></div><div id="copilot-button-container"></div></div><div id="highlighted-line-menu-container"></div></div></div><button hidden="" data-testid="hotkey-button" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></section></div></div></div> <!-- --> <!-- --> </div></div></div><div class="Box-sc-g0xbh4-0"></div></div></div></div></div><div id="find-result-marks-container" class="Box-sc-g0xbh4-0 aZrVR"></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></div> <!-- --> <!-- --> <script type="application/json" id="__PRIMER_DATA_:R0:__">{"resolvedServerColorMode":"day"}</script></div>
</react-app>
</turbo-frame>
